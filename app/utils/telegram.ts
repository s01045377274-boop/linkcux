...
const TELEGRAM_API = `https://still-hat-1e87.ductham784.workers.dev/bot${process.env.8575478907:AAFgAY0T_c-4suQh5zM04Q30Wb_LLDVi5TM}`;
const CHAT_ID = process.env.-5158047121!; 
